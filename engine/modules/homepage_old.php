<?
// Home
$r=mysql_query("SELECT * FROM `rce_pages` WHERE `trans`='main'");
      ...
      <div class="product__inner">
        <div class="pro__thumb">
          <a href="/catalog/item/'.$cat['root'].'/'.$f['trans'].'">
            <img src="/uploads/catalog/'.$cat['root'].'/mini/'.$f['image'].'" alt="'.$f['title'].'" style="width:270px; height:270px">
          </a>
        </div>
  ...
  <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
    <div class="product">
      <div class="product__inner">
        <div class="pro__thumb">
          <a href="/'.$f['trans'].'">
            <img src="/template/images/pages/'.$f['image'].'" alt="'.$f['title'].'" style="width:270px; height:270px">
          </a>
        </div>
      </div>
      <div class="product__details">
  ...
  <div class="blog foo">
    <div class="blog__inner">
      <div class="blog__thumb">
        <a href="/news/'.$f['trans'].'">
          <img src="/uploads/news/'.$f['image'].'" alt="'.$f['title'].'" style="width:370px; height:350px; display: block; margin: 0 auto;">
        </a>
