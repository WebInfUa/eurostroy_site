...
<div style="width: 95%; max-width: 750px; background-color: rgba(0, 0, 0, 0.1); padding: 10px; border-radius: 20px; margin: 0 auto;">
  ...
  <div>
    ...
    <p>Поступил новый запрос на обратный звонок с сайта!</p>
    <ul style="font-size: 14px;">
      <li style="margin-bottom: 15px;"><b>Имя заказчика: </b>'.$_POST['name'].'</li>
      <li  style="margin-bottom: 15px;"><b>Контактный телефон: </b>'.$_POST['phone'].'</li>
    </ul>
    <p style="color: #c00c00; font-size: 16px; font-weight: bold;">
      Быстрый набор '.$_POST['name'].' по ссылке <a href="tel:'.$_POST['phone'].'">'.$_POST['phone'].'</a>
    </p>
  </div>
...
$theMailer->SetFrom('info@bud-komplekt.com.ua', 'Обратный звонок Eurostroy');
